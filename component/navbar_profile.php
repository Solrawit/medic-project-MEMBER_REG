  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="./page_user/text_photo.php"><i class="fa fa-coffee fa-lg"></i> แปลงข้อความ <span class="sr-only"></span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="./page_user/alert_time.php"><i class="fa fa-plus-square fa-lg"></i> ตั้งค่าการแจ้งเตือน <span class="sr-only"></span></a>
        </li>
        <li class="nav-item">
