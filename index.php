...
<style>
    ...
    .jumbotron {
      background-color: #59A7E5; /* index ic */123
      color: #ffffff; /* สีตัวอักษรของ jumbotron */456
              ...
              <div class="col-md-3"> <!-- ให้รูปภาพใน column ขนาด 3/12 -->
                ...
                <div id="carouselExampleIndicators<?php echo $i; ?>" class="carousel slide" data-ride="carousel">
                  <ol class="carousel-indicators">
                    <li data-target="#carouselExampleIndicators<?php echo $i; ?>" data-slide-to="0" class="active"></li>
                    <li data-target="#carouselExampleIndicators<?php echo $i; ?>" data-slide-to="1"></li>
                    <li data-target="#carouselExampleIndicators<?php echo $i; ?>" data-slide-to="2"></li>
                  </ol>
