...
<nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="index.php"><i class="fa fa-coffee fa-lg"></i> สนับสนุนค่ากาแฟ <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="index.php"><i class="fa fa-plus-square fa-lg"></i> ช่องทางการติดต่อ <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="index.php"><i class="fa fa-youtube-play fa-lg"></i> วิธีการใช้งาน <span class="sr-only">(current)</span></a>
      </li>
    </ul>
    <?php
    if ($_SESSION == NULL) {
